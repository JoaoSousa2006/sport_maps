...
CREATE TABLE tblplaces (
    ...
    HorarioFuncionamento VARCHAR(255) NOT NULL DEFAULT '',
...
-- Inserção de registros na tabela placesScores
INSERT INTO placesScores (idUser, idPlace, votes) VALUES
(1, 9, 87),
(5, 6, 21),
(5, 12, 10),
(5, 11, 23),
...
-- Inserção de registros na tabela tblFeedbacks
INSERT INTO tblFeedbacks (idUser, idPlace, ContentFeedback, votes) VALUES
(1, 9, 'Ótimo local para praticar esporte!', 5),
(5, 6, 'Gostei muito da estrutura e do ambiente.', 4),
(5, 12, 'Excelente para quem busca um lugar tranquilo.', 5),
(5, 11, 'Preço justo e boas instalações.', 4),
(1, 19, 'Poderia melhorar um pouco a manutenção.', 2),
(4, 18, 'Experiência incrível, recomendo!', 5),
(4, 1, 'Funcionários atenciosos e ambiente acolhedor.', 4),
(1, 15, 'Localização muito boa.', 3),
(2, 7, 'Precisa de mais opções de esporte.', 3),
(3, 10, 'Boa iluminação e segurança.', 4),
(2, 9, 'Ambiente agradável e limpo.', 4),
(5, 17, 'Ótimo para família e amigos.', 5),
(1, 13, 'Um pouco barulhento, mas funcional.', 3),
(4, 15, 'Atendimento excelente!', 5),
(2, 12, 'Instalações modernas e bem cuidadas.', 4),
(3, 11, 'Fácil acesso e boa infraestrutura.', 4),
(2, 19, 'Recomendo para todos os níveis.', 5),
(4, 10, 'Bom custo-benefício.', 3),
(3, 7, 'Um lugar para se exercitar em paz.', 5),
(5, 13, 'Muita variedade de equipamentos.', 4),
(1, 17, 'Bom, mas o horário é limitado.', 3),
(4, 19, 'Limpo e organizado.', 4),
(1, 8, 'Acesso fácil e estacionamento.', 4),
(3, 6, 'Poderia ser maior.', 2),
(4, 8, 'Ambiente familiar.', 4),
(3, 12, 'Seguro e bem frequentado.', 5),
(1, 11, 'Serviço rápido e eficiente.', 4),
(5, 18, 'Top! Voltarei com certeza.', 5),
(2, 15, 'Equipamentos novos.', 4),
(3, 13, 'Perfeito para relaxar e se exercitar.', 5),
(2, 1, 'Muito bom, recomendo a visita.', 5),
(5, 19, 'Preço justo e boa estrutura.', 4),
(4, 14, 'Ambiente calmo para treinar.', 4),
(3, 8, 'Com certeza voltarei!', 5),
(1, 10, 'Equipe atenciosa.', 4),
(5, 1, 'Ótimo para quem gosta de esportes aquáticos.', 5),
(2, 18, 'Muito bom para o dia a dia.', 4),
(4, 7, 'Otimas aulas.', 5),
(3, 15, 'Experiência agradável.', 4),
(1, 6, 'Um dos melhores locais da região.', 5),
(2, 13, 'Voltarei em breve.', 4),
(5, 10, 'Ótimo para praticar com amigos.', 5),
(4, 11, 'Limpo e seguro.', 4),
(2, 6, 'Poderia ter mais bebedouros.', 3),
(1, 14, 'Excelente local para um bom treino.', 5),
(3, 17, 'Ambiente muito bom.', 4),
(5, 7, 'Perfeito para quem busca qualidade.', 5),
(3, 18, 'Muito bom para todas as idades.', 4),
(4, 6, 'Ótima localização.', 4),
(1, 12, 'Bom espaço e conforto.', 4);
