...
if ($count > 0) {
    ...
    // s: string (HorarioFuncionamento)
    $stmt->bind_param("ssssssddds", $namePlace, $adressPlace, $emailPlace, $phonePlace, $priceRange, $sportType, $latPlace, $longPlace, $horarioFuncionamento);
