...
if ($row = $result->fetch_assoc()) {
    ...
    // Insere novo voto
    $insert = $connection->prepare("INSERT INTO placesScores (idUser, idPlace, SportType, votes) VALUES (?, ?, '', ?)");
...
$total = $connection->query("SELECT SUM(votes) as total FROM placesScores WHERE idPlace = $idPlace")->fetch_assoc()['total'];
